 ...
 */
final class Version20190111004854 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE announcement CHANGE created_by created_by VARCHAR(255) DEFAULT NULL COLLATE utf8_general_ci, CHANGE updated_by updated_by VARCHAR(255) DEFAULT NULL COLLATE utf8_general_ci');
    }
}
